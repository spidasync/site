...
document.getElementById('about-link').addEventListener('click', function() {
    document.getElementById('content-area').innerHTML = `
        <div id="main-content">
            <h1>About Us</h1>
            <h2>Crosshair Games is an Australian independent game studio established June 3rd, 2020 and run by a 16 year old solo developer.</h2> <!-- Added the subtitle here -->
            <p>Crosshair Games™</p>
        </div>
    `;
});
